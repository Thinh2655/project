...
@section('content')
    ...
    <div class="container-fluid">
        <div class="container p-0">
            <div class="filter-bar" style="background-color: #fff;">
                    ...
                    <div class="dropdown me-2">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item"
                                    href="{{ route('admin.product', array_merge(request()->query(), ['per_page' => 8])) }}">8</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{ route('admin.product', array_merge(request()->query(), ['per_page' => 16])) }}">16</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="{{ route('admin.product', array_merge(request()->query(), ['per_page' => 32])) }}">32</a>
                            </li>
                        </ul>
                    </div>
