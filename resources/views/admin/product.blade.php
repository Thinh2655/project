...
@section('content')
    ...
    @foreach ($product as $product)
        <section class="product-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-6" id="containerImage">
                        <img src="{{ $product->image_url }}" alt="Asgaard sofa" class="product-image">
                        <div class="thumbnail-images">
                            <img src="https://placehold.co/80x80" alt="Asgaard sofa thumbnail 1"
                                class="thumbnail editableImage">
                            <img src="https://placehold.co/80x80" alt="Asgaard sofa thumbnail 2"
                                class="thumbnail editableImage">
                            <img src="https://placehold.co/80x80" alt="Asgaard sofa thumbnail 3"
                                class="thumbnail editableImage">
                            <img src="https://placehold.co/80x80" alt="Asgaard sofa thumbnail 4"
                                class="thumbnail editableImage">
                            <img src="https://placehold.co/80x80" alt="Asgaard sofa thumbnail 4"
                                class="thumbnail editableImage">
                            <img src="https://placehold.co/80x80" alt="Asgaard sofa thumbnail 4"
                    ...
                    <div class="col-md-6">
                        <div class="product-details">
                            <h1 class="product-title" contenteditable="true">{{ $product->name }}</h1>
                            <p class="product-price" contenteditable="true">{{ $product->price }}₫</p>
                            <div class="rating">
                ...
                <div class="tab-pane fade show active" id="description" >
                    <div id="editorDepcription">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <img src="https://placehold.co/400x300" alt="Product description image 2"
                                    class="img-fluid">
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        //trình chỉnh sửa
        ClassicEditor
            .create(document.querySelector('#editorDepcription'), {
                // Các plugin cơ bản, không có Image Upload
        ...
        // Thêm sự kiện cho tất cả ảnh có class 'editableImage'
        containerImage.addEventListener('click', function(event) {
            if (event.target && event.target.tagName === 'IMG') {
                imageUpload.click();
                // Lưu trữ ảnh đang được chỉnh sửa
                imageUpload.currentImage = event.target;
            }
        });

        // Khi chọn file mới, thay đổi src của ảnh
        imageUpload.addEventListener('change', function(event) {
            const file = event.target.files[0];
            if (file && imageUpload.currentImage) {
                const reader = new FileReader();
                reader.onload = function(e) {
                    imageUpload.currentImage.src = e.target.result;
                }
